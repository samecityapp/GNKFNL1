...
export function MobileHotelInfo({
  ...
  return (
    <div className="relative -mt-12 bg-white rounded-t-[2rem] pt-6 pb-6 shadow-lg">
      <div className="px-5">
        <h1 className="text-2xl font-normal text-gray-900 mb-2 leading-tight text-center">
          {hotelName}
        </h1>
        ...
        <div className="flex items-center justify-center gap-0 mb-6">
          <div className="flex flex-col items-center justify-center bg-white rounded-xl p-3 h-[100px] min-w-[100px]">
            <p className="text-base font-medium text-gray-700 mb-1">GNK Skor</p>
            <p className="text-lg font-medium text-gray-700">{rating} / 5</p>
          </div>

          <div className="h-16 w-[1px] bg-gray-200 mx-1"></div>

          <div
            className="relative flex flex-col items-center justify-center bg-white rounded-xl p-2 h-[100px] min-w-[100px] overflow-hidden cursor-pointer"
          ...
          <div className="flex flex-col gap-2 mb-6">
            {websiteUrl && (
              <a
                ...
                className="flex items-center justify-center gap-2 bg-white border border-gray-900/30 hover:bg-gray-900 text-gray-900 hover:text-white font-semibold py-3 px-6 rounded-xl transition-colors"
              >
                <span>Otele Git</span>
              </a>
            )}
